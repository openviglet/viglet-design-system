...
/**
 * The `tfoot` of a `Table`, for totals.
 */
...
/**
 * A row of a `Table`, highlighted on hover and while its `data-state` is
 * `selected`.
 */
...
/**
 * A `Table`'s caption, set under it, which also names the table for a screen
 * reader.
 */
