...
const preview: Preview = {
  // VDS53 — every story renders through here, so this is where each one hands
  // the gate the errors it means to produce. The capture and the assertion live
  // in console-error-gate.ts, which explains why they cannot live in this hook.
  beforeEach: (context) => {
    allowConsoleErrors(
      (context.parameters.expectedConsoleErrors ?? []) as (string | RegExp)[],
    );
  },
  parameters: {
    layout: "centered",
