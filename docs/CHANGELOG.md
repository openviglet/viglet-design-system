...
- ✅ **VDS4 (workflow half)** **the component catalogue is built into storybook-static and published nowhere a product author can open** — A Pages workflow builds and deploys the catalogue on every 2026.3 commit, and the README links it as the first thing a reader meets.
